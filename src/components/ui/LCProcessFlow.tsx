const LCProcessFlow = () => (
  <div className="rounded-xl bg-[#EBEBE9] px-8 py-9">
    <svg width="100%" viewBox="0 0 620 480" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Title */}
      <text x="310" y="30" textAnchor="middle" fontFamily="'Inter',system-ui,sans-serif" fontWeight="700" fontSize="20" fill="#2C2A25">Letter of credit process flow</text>
      ...
      <line x1="80" y1="160" x2="80" y2="290" stroke="#7A7872" strokeWidth="1.2" markerEnd="url(#a)" />
      ...
      <line x1="190" y1="320" x2="430" y2="320" stroke="#7A7872" strokeWidth="1.2" markerEnd="url(#a)" />
      ...
      <line x1="556" y1="290" x2="556" y2="160" stroke="#7A7872" strokeWidth="1.2" markerEnd="url(#a)" />
      ...
      <path d="M510 100 L510 82 L110 82 L110 100" fill="none" stroke="#6B7D5E" strokeWidth="1.5" markerEnd="url(#a)" />

      {/* Step 5: Payment settled */}
      <path d="M110 350 L110 385 L510 385 L510 350" fill="none" stroke="#6B7D5E" strokeWidth="1.2" strokeDasharray="5 3" markerEnd="url(#a)" />
      ...
      {/* Legend */}
      <line x1="100" y1="432" x2="135" y2="432" stroke="#7A7872" strokeWidth="1.2" markerEnd="url(#a)" />
      <text x="142" y="436" fontFamily="'Inter',system-ui,sans-serif" fontWeight="400" fontSize="10" fill="#7A7872">LC issuance flow</text>

      <line x1="270" y1="432" x2="305" y2="432" stroke="#6B7D5E" strokeWidth="1.5" markerEnd="url(#a)" />
      <text x="312" y="436" fontFamily="'Inter',system-ui,sans-serif" fontWeight="400" fontSize="10" fill="#6B7D5E">{"Goods & payment"}</text>

      <path d="M430 432 L465 432" fill="none" stroke="#6B7D5E" strokeWidth="1.2" strokeDasharray="5 3" markerEnd="url(#a)" />
